...
def add_field(filename, fields):
    ...
    with open(filename, "r") as f:
        ...
        for ln in reader:
            ...
            ######clean up the 'rdf-schema#label' the same way as in the first exercise - removing redundant "(spider)" suffixes - SAME CODE as PS1
            ...
            #- return a dictionary with the cleaned 'rdf-schema#label' field values as keys,  and 'binomialAuthority_label' field values as values
            if ln['binomialAuthority_label'] != "NULL":
                data[ln['rdf-schema#label']] = ln['binomialAuthority_label']
