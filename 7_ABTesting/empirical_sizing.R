...
required_size(s=sqrt(0.2062* (1-0.2062)*2), d_min=0.01  , alpha=0.0167)
required_size(s=sqrt(0.53  * (1-0.53  )*2), d_min=0.01  , alpha=0.0167)
required_size(s=sqrt(0.1093* (1-0.1093)*2), d_min=0.0075, alpha=0.0167)
