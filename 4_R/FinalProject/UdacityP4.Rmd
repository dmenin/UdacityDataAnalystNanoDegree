...
<p style='text-align: justify;'>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Now that we've looked at how the variables are correlated with each other, let's try to find out how we can select a few of them to infer the quality of the Wine. To do that, I will run 3 different analysis and in the end will sumarize the results.
</p>
...
2. total.sulfur.dioxide: In this case I can really tell why free.sulfur.dioxide was chosen over total. sulfur.dioxide by the RFE. I can only speculate that it doesn't matter that much because: 1) these two have a high level of correlation (0.61) and if we look at the LVQ output, they are pretty similar in importance.
</P>
